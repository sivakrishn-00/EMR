...
class LabMachineData(models.Model):
    ...
    # Biochemistry Parameters (Floats as per the machine output)
    alb = models.FloatField(null=True, blank=True)
    alp = models.FloatField(null=True, blank=True)
    dbil = models.FloatField(null=True, blank=True)
    tbil = models.FloatField(null=True, blank=True)
    chol = models.FloatField(null=True, blank=True)
    crea = models.FloatField(null=True, blank=True)
    ...
    tgl = models.FloatField(null=True, blank=True)
    urea = models.FloatField(null=True, blank=True)
    uric = models.FloatField(null=True, blank=True)
    ...
    amyl = models.FloatField(null=True, blank=True)
    ibil = models.FloatField(null=True, blank=True)
    ...
    direct_ldl = models.FloatField(null=True, blank=True)
